...
impl fmt::Display for StationType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            StationType::PassengerCar => write!(f, "Passenger Car"),
            StationType::Bus => write!(f, "Bus"),
            StationType::LightTruck => write!(f, "Light Truck"),
            StationType::HeavyTruck => write!(f, "Heavy Truck"),
            StationType::Trailer => write!(f, "Trailer"),
            StationType::SpecialVehicle => write!(f, "Special Vehicle"),
            StationType::Tram => write!(f, "Tram"),
            StationType::LightVruVehicle => write!(f, "Light Vru Vehicle"),
            StationType::Animal => write!(f, "Animal"),
            StationType::Agricultural => write!(f, "Agricultural"),
            StationType::RoadSideUnit => write!(f, "Roadside Unit"),
...
#[cfg(feature = "asn1")]
use veloce_asn1::defs::etsi_messages_r2::etsi__its__cdd::{
