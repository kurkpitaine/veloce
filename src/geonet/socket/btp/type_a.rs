...
use crate::geonet::network::{GnCore, Transport, UnicastReqMeta, UpperProtocol};
#[cfg(feature = "async")]
...
use crate::geonet::wire::{BtpAHeader, BtpARepr, EthernetAddress, GeonetUnicast};
...
pub type RxPacketMetadata = crate::geonet::storage::PacketMetadata<(BtpAMetadata, Indication)>;
pub type TxPacketMetadata = crate::geonet::storage::PacketMetadata<(BtpAMetadata, Request)>;

/// A BTP-A packet ring buffer.
pub type RxPacketBuffer<'a> = crate::geonet::storage::PacketBuffer<'a, (BtpAMetadata, Indication)>;
pub type TxPacketBuffer<'a> = crate::geonet::storage::PacketBuffer<'a, (BtpAMetadata, Request)>;
