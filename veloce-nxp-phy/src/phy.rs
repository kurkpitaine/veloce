...
use crate::{
    cfg_mk5, eMKxIFMsgType_MKXIF_ERROR, eMKxIFMsgType_MKXIF_RXPACKET, eMKxIFMsgType_MKXIF_TXPACKET,
    eMKxStatus_MKXSTATUS_RESERVED, tMKxIFMsg, tMKxRadioConfig, tMKxRxPacket, tMKxTxPacket,
    usb::USB, Error, Result, LLC_BUFFER_LEN, RAW_FRAME_LENGTH_MAX,
};

/// An NXP SAF 5X00 device.
#[derive(Debug)]
pub struct NxpDevice {
